...
const uncoordinatedCount = intersections.filter(i => i.status === 'identified').length;
...
const NAV = [
  ...
  { to: '/strategy-map', label: 'Strategy Map', badge: uncoordinatedCount, badgeColor: 'bg-amber-500', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6m6 0h6m-6 0V9a2 2 0 012-2h2a2 2 0 012 2v10m6 0v-4a2 2 0 00-2-2h-2a2 2 0 00-2 2v4' },
  { to: '/action-items', label: 'Action Items', badge: overdueCount, badgeColor: 'bg-red-500', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4' },
  { to: '/cadences', label: 'Cadences', badge: pendingMeetings || null, badgeColor: 'bg-amber-500', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
  { to: '/content', label: 'Content Hub', icon: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253' },
];
        ...
        {NAV.map((item) => {
          ...
          return (
            ...
            >
              ...
              {item.badge > 0 && (
                <span className={`${item.badgeColor || 'bg-red-500'} text-white text-[10px] font-bold w-5 h-5 rounded-full flex items-center justify-center`}>
                  {item.badge}
                </span>
              )}
            </Link>
