...
import { leaders, financials, GROUPS } from '../data';
  ...
  return (
    <div className="p-6 max-w-[1400px] mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-display font-bold text-gray-900">All Leaders</h1>
          <p className="text-sm text-gray-500 mt-0.5">{filtered.length} leaders</p>
        </div>
